<div align="center">
  ...
  <p><em>A modern, sleek theme featuring deep obsidian backgrounds with warm undertones</em></p>
</div>
...
| **Midnight** | `#16131a` | ![#16131a](./color_swatches/16131a.bmp) | Editor background, surfaces |
| **Dark Mauve** | `#1e1a1c` | ![#1e1a1c](./color_swatches/1e1a1c.bmp) | Elevated surfaces, active tabs |
| **Warm Graphite** | `#2a2426` | ![#2a2426](./color_swatches/2a2426.bmp) | Hover states, borders |
| **Charcoal Plum** | `#322a2e` | ![#322a2e](./color_swatches/322a2e.bmp) | Active elements |
| **Dark Taupe** | `#3a3034` | ![#3a3034](./color_swatches/3a3034.bmp) | Selected elements |
...
| **Coral Red** | `#ff4466` | ![#ff4466](./color_swatches/ff4466.bmp) | Bright accent, highlights |
| **Salmon** | `#ff6688` | ![#ff6688](./color_swatches/ff6688.bmp) | Links, constructors |
| **Peach** | `#ff8866` | ![#ff8866](./color_swatches/ff8866.bmp) | Numbers, constants |
| **Blush** | `#ffaacc` | ![#ffaacc](./color_swatches/ffaacc.bmp) | Parameters (dark) |

### Secondary Colors

| Name | Hex | Preview | Usage |
|------|-----|---------|-------|
| **Emerald** | `#50c878` | ![#50c878](./color_swatches/50c878.bmp) | Strings (dark), success |
...
| **Magenta** | `#d946ef` | ![#d946ef](./color_swatches/d946ef.bmp) | Preprocessor (dark) |
